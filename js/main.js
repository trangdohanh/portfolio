...
app.component('footer-el', {
    template: `<footer class="grid row-gap-8">
                    ...
                    <div class="contacts flex row-gap-8">
                        <div class="contact">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" width="1.25rem" height="1.25rem"><!--!Font Awesome Free v7.0.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc. -->
...
app.component('header-el', {
    template: `<header>
                    <div class="grid desktop-columns-4 tablet-columns-3 mobile-columns-2">
                        <a href="../" class="logo">
                            <svg viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg" width="1rem" height="1rem">
