...
var infographics = `<div class="thumbnails" style="grid-template-columns: repeat(6, 1fr);">
                      <div class="thumbnail" onclick="currentSlide(1)"><img src="img/info-visualization/info-visual-1.jpg"></div>
                      <div class="thumbnail" onclick="currentSlide(2)"><img src="img/info-visualization/info-visual-2.jpg"></div>
                      <div class="thumbnail" onclick="currentSlide(3)"><img src="img/info-visualization/info-visual-3.jpg"></div>
                      <div class="thumbnail" onclick="currentSlide(4)"><img src="img/info-visualization/info-visual-4.jpg"></div>
                      <div class="thumbnail" onclick="currentSlide(5)"><img src="img/info-visualization/info-visual-5.jpg"></div>
                      <div class="thumbnail" onclick="currentSlide(6)"><img src="img/info-visualization/info-visual-6.jpg"></div>
                    </div>
...
var coffee = `<div class="thumbnails" style="grid-template-columns: repeat(9, 1fr);">
                  <div class="thumbnail" onclick="currentSlide(1)"><img src="img/coffee-mill/mockup-1.jpg"></div>
                  <div class="thumbnail" onclick="currentSlide(2)"><img src="img/coffee-mill/mockup-2.jpg"></div>
                  <div class="thumbnail" onclick="currentSlide(3)"><img src="img/coffee-mill/mockup-3.jpg"></div>
                  <div class="thumbnail" onclick="currentSlide(4)"><img src="img/coffee-mill/mockup-4.jpg"></div>
                  <div class="thumbnail" onclick="currentSlide(5)"><img src="img/coffee-mill/mockup-5.jpg"></div>
                  <div class="thumbnail" onclick="currentSlide(6)"><img src="img/coffee-mill/mockup-6.jpg"></div>
                  <div class="thumbnail" onclick="currentSlide(7)"><img src="img/coffee-mill/mockup-7.jpg"></div>
                  <div class="thumbnail" onclick="currentSlide(8)"><img src="img/coffee-mill/mockup-8.jpg"></div>
                  <div class="thumbnail" onclick="currentSlide(9)"><img src="img/coffee-mill/mockup-9.jpg"></div>
                </div>
