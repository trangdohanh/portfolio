...
mc.on("panup tap", function() {
    mySummary.style.bottom = "5rem";
    document.getElementById('openForm').style.bottom = "20rem";
});
mc.on("pandown", function() {
    mySummary.style.bottom = "-4rem";
    document.getElementById('openForm').style.bottom = "11rem";
});
